...
Widget _customTimeline(String text,  VoidCallback onTap,bool isSelected){
  return Column(
    mainAxisAlignment: MainAxisAlignment.start,
    children: [
      InkWell( onTap: onTap, child: !isSelected?Icon(Icons.circle_outlined):Icon((Icons.circle))),
...
Widget _dash(double width){
  return customContainer(bRadius: 1,height: 4,width:width*0.08,containerColor: Colors.grey);
